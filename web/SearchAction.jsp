<%-- 
    ...
    Created on : Jan 3, 2020, 4:07:50 PM
    Author     : Acer
--%>
     ...
     <section class="best-offer" id=best-offer-section>
        <div id="content">
                              ...
                              String keyword=request.getParameter("keyword");
                                %>
                                <center><h2><font color="red">View Files</font></h2></center>
                                    ...
                                    <%
                                        while(rs.next())
                                        {
                                            ...
                                            if(s.contains(keyword)){
                                                Queries.getExecuteUpdate("insert into transaction values(null,'"+username+"','"+rs.getString("filename")+"','Search',now())");
                                            ...
                                            <tr>
                                                ...
                                                <td><textarea cols="40" rows="20" style="background:blanchedalmond;"><%=rs.getString("cipher")%></textarea></td>
                                                <td><a href="SendDescReqs.jsp?id=<%=rs.getString("id")%>&owner=<%=rs.getString("owner")%>&filename=<%=rs.getString("filename")%>">Send Decrypt Request</a></td>             
                                            </tr>
                                        <%}
}
}
