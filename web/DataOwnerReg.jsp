                ...
                <div class="col-md-8">
                    <div class="best-offer-right-content">
                        <div class="row">
                          ...
                          <h3><em>Data Owner Registration</em></h3>
                                <form name="login" action="DataOwnerRegAction.jsp" method="post">
                                <table
                                       <tr>
                                    ...
                                    <tr>
                                        <td>Location</td><td><input type="text" name="location" required=""></td>
                                    </tr>
