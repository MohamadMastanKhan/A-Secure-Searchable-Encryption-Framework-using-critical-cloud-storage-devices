...
<body>
    ...
    <section class="banner" id="top">
     ...
     <section class="best-offer" id=best-offer-section>
        <div id="content">
            <center>
                <form action="VerifyKeyAction.jsp" method="post">
            <table>
                 <h3>Verify Token</h3>
          ...
          <tr><th>Token:</th><td><input type="text" name="token"  value="<%=r.getString("token")%>"></td></tr> 
...
out.println(e);
                                    ...
                                    <tr><th></th><td><input type="submit" value="Verify Token"></td></tr>
                                     </table>
                </form>
                                </center>
