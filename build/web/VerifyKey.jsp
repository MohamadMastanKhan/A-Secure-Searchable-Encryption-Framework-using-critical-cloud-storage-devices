     ...
     <section class="best-offer" id=best-offer-section>
        <div id="content">
                              ...
                              String fid=request.getParameter("fid");
                                ...
                                %>
                                <center><h2><font color="red">Cipher Data</font></h2></center>
                                <center>
                                    <table>
                                        <tr><th>Cipher Data</th></tr>
                                        <%try{
                                     ...
                                     while(r.next()){
                                       ...
                                       %>
                                        <tr><td><textarea cols="50" rows="20"><%=r.getString("cipher")%></textarea></td></tr>  
                                        <%
...
out.println(e);
                                    ...
                                    <table>
                                        <tr><h2>Enter Key To Decrypt</h2></tr>
                                          <tr>
                                            <th>File ID:</th><td><input type="text" name="fid" value="<%=fid%>" required=""></td>
                                        </tr>
                                         <tr>
                                            <th></th><td><input type="hidden" name="id" value="<%=id%>" required=""></td>
                                        </tr>
                                         <tr>
                                            <th></th><td><input type="hidden" name="filename" value="<%=filename%>" required=""></td>
                                        </tr>
                                        <tr>
                                            <th>Enter Decrypt Key:</th><td><input type="text" name="deckey" required=""></td>
                                        </tr>
                                         <tr>
                                            <th></th><td><input type="submit" value="Verify" required=""></td>
                                        </tr>
