...
<%
  ...
  ResultSet rs=st.executeQuery("select * from desreq ");
  %>
                                    ...
                                    <%
                                        while(rs.next())
                                        {
                                            ...
                                            <tr>
                                               ...
                                               <%
                                               if(deskey.equals("waiting")){
                                                 %>
                                                 <td><a href="GenerateDecKey.jsp?id=<%=rs.getString("id")%>&email=<%=rs.getString("email")%>">Generate</a></td>   
