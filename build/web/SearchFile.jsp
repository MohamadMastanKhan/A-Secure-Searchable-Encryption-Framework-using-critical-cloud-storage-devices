     ...
     <section class="best-offer" id=best-offer-section>
        <div id="content">
                              <% String username=(String)session.getAttribute("username");
                                %>
                                <center><h2><font color="red">Search File</font></h2></center>
                                ...
                                <center>  
                                    ...
                                    <table border="2px">
                                    <tr>
                                        <th>Enter keyword</th><td><input type="text" name="keyword" required=""></td>
                                      </tr>
                                        <tr>
                                        <th></th><td><input type="submit" value="Search" ></td>
                                      </tr>
                                         </table>
                                    </form>
                                </center>
