                ...
                <div class="col-md-8">
                    <div class="best-offer-right-content">
                        <div class="row">
                            ...
                            <h2><em>Upload File : " <%=username%> "</em></h2>
                                ...
                                <div class="pink-button">
                                    ...
                                    <form action="UploadAction" method="post" enctype="multipart/form-data">
                                        <table>
                                            <tr><td><input type="text" name="filename" required="" placeholder="Enter FileName"></td></tr>
                                     
                                            <tr><td><input type="text" name="key" required="" placeholder="Enter Keyword"></td></tr>
                                              
                                            <tr><td><input type="file" name="file" required=""></td></tr>
                                       <tr><td><input type="submit" value="Upload" required=""></td></tr>
